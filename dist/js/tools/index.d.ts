declare const _default: {
    surface: {
        generateConfig: (material: {
            ...
            unsetFileProps(): void;
            setBasis(textOrObject: any, format?: string | undefined, unitz?: string | undefined): void;
    ...
    supercell: {
        generateConfig: (material: {
            ...
            readonly slug: string;
            readonly isSystemEntity: boolean;
        } & import("@mat3ra/code/dist/js/entity/in_memory").InMemoryEntity, supercellMatrix: import("@mat3ra/esse/dist/js/types").Matrix3X3Schema) => {
            name: string;
