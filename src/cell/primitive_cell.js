...
const PRIMITIVE_CELLS = {
    ...
    [LATTICE_TYPE.RHL]: ({a, b, c, alpha, beta, gamma}) => {
        ...
        return [
            ...
            [a * cosHalfAlpha, a * sinHalfAlpha, 0.0],
            [a * cosAlpha / cosHalfAlpha, 0.0, a * math.sqrt(1 - cosAlpha * cosAlpha / (cosHalfAlpha * cosHalfAlpha))],
        ];
    },
    ...
    [LATTICE_TYPE.TRI]: ({a, b, c, alpha, beta, gamma}) => {
        ...
        [alpha, beta, gamma] = [alpha, beta, gamma].map(x => math.unit(x, 'degree').to('rad').value);
    ...
    [LATTICE_TYPE.TRI + 'alt']: ({a, b, c, alpha, beta, gamma}) => {
        ...
        return [
            ...
            [
                ...
                c / sinGamma * math.sqrt(
                    sinGamma * sinGamma - cosAlpha * cosAlpha - cosBeta * cosBeta + 2 * cosAlpha * cosBeta * cosGamma
                )
            ]
        ];
    },
