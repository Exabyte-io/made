...
const POINTS = {
    ...
    [LATTICE_TYPE.ORCF]: ({a, b, c, alpha, beta, gamma}) => {
        if (1 / (a * a) >= 1 / (b * b) + 1 / (c * c)) {
            // ORCF-1,3
            var n = (1 + a * a / (b * b) + a * a / (c * c)) / 4;
            var e = (1 + a * a / (b * b) - a * a / (c * c)) / 4;
            return [
                {
                    point: 'A',
                    coordinates: [
            ...
            // ORCF-2
            var n = (1 + a * a / (b * b) - a * a / (c * c)) / 4;
            var f = (1 + c * c / (b * b) - c * c / (a * a)) / 4;
            var d = (1 + b * b / (a * a) - b * b / (c * c)) / 4;
            return [
                {
                    point: 'C',
                    coordinates: [
    ...
    [LATTICE_TYPE.RHL]: ({a, b, c, alpha, beta, gamma}) => {
        ...
        if (cosAlpha > 0) {
            // RHL-1
            var n = (1 + 4 * cosAlpha) / (2 + 4 * cosAlpha);
            var v = (3 / 4 - n / 2);
            return [
                {
                    point: 'B',
            ...
            // RHL-2
            var n = 1 / 2 * (1 + cosAlpha) / (1 - cosAlpha);
            var v = (3 / 4 - n / 2);
            return [
                {
                    point: 'F',
    ...
    [LATTICE_TYPE.MCL]: ({a, b, c, alpha, beta, gamma}) => {
        const cosAlpha = Math.cos(alpha / 180 * Math.PI);
        var n = 1 / 2 * (1 - b * cosAlpha / c) / (1 - cosAlpha * cosAlpha);
        var v = (1 / 2 - n * c * cosAlpha / b);
        return [
            {
                point: 'A',
                coordinates: [
    ...
    [LATTICE_TYPE.MCLC]: ({a, b, c, alpha, beta, gamma}) => {
        ...
        if (gamma >= 90) {
            // MCLC-1,2
            var e = (2 - b * cosAlpha / c) / (4 * (1 - cosAlpha * cosAlpha));
            var n = (1 / 2 + 2 * e * c * cosAlpha / b);
            var p = 3 / 4 - a * a / (4 * b * b * (1 - cosAlpha * cosAlpha));
            var f = p + (3 / 4 - p) * cosAlpha * b / c;
            return [
                {
                    point: 'N',
                    coordinates: [
            ...
            // MCLC-3,4
            var m = (1 + b * b / (a * a)) / 4;
            var d = b * c * cosAlpha / (2 * a * a);
            var e = m - 1 / 4 + (1 - b * cosAlpha / c) / (4 * (1 - cosAlpha * cosAlpha));
            var n = 1 / 2 + 2 * e * c * cosAlpha / b;
            var f = 1 + e - 2 * m;
            var p = n - 2 * d;
            return [
            ...
            // MCLC-5
            var e = 1 / 4 * (b * b / a * a + (1 - b * cosAlpha / c) / (1 - cosAlpha * cosAlpha));
            var m = n / 2 + b * b / (a * a) / 4 - b * c * cosAlpha / (2 * a * a);
            var w = (4 * v - 1 - b * b * (1 - cosAlpha * cosAlpha) / (a * a)) * c / (2 * b * cosAlpha);
            var n = 1 / 2 + 2 * e * c * cosAlpha / b;
            var d = e * c / b * cosAlpha + w / 2 - 1 / 4;
            var v = 1 + e - 2 * m;
            var r = 1 - e * a * a / (b * b);
            return [
                {
