...
class StackComponentDict(BaseModel):
    """
    ...
    Optional fields:
        xy_supercell: Optional supercell matrix for the xy plane
    """
    ...
    xy_supercell: Optional[List[List[int]]] = Field(None, description="Optional xy supercell matrix")

    class Config:
        arbitrary_types_allowed = True  # Allow Material objects
