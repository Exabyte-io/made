...
class CoordinationBasedPassivationMaterialAnalyzer(MaterialWithCrystalSites, SurfacePassivationMaterialAnalyzer):
    """
    ...
    def get_passivant_coordinates(
        ...
        undercoordinated_atoms_indices = self.get_undercoordinated_atom_indices(
        ...
        bonds_templates = self.find_unique_bond_directions()
        reconstructed_bonds: List[BondDirections] = self.find_missing_bonds_for_all_sites(
