...
class PerturbationBuilder(BaseBuilder):
    ...
    _GeneratedItemType: MaterialWithBuildMetadata = MaterialWithBuildMetadata
    _PostProcessParametersType: Any = None

    @staticmethod
    def _prepare_material(configuration: _ConfigurationType) -> MaterialWithBuildMetadata:
        ...
        # Ensure it's a MaterialWithBuildMetadata
        if not isinstance(new_material, MaterialWithBuildMetadata):
            new_material = MaterialWithBuildMetadata.create(new_material.to_dict())
        return new_material

    def _generate(self, configuration: _ConfigurationType) -> List[MaterialWithBuildMetadata]:
    ...
    def _post_process(
        self,
        items: List[MaterialWithBuildMetadata],
