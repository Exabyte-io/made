...
*/
    ...
    static getCovalentRadius(name) {
        if (ElementUtil.Element[name] === undefined) {
            return -1;
        }

        return ElementUtil.Element[name][1];
...
*/
    ...
    static getAtomicNumber(name) {
        if (ElementUtil.Element[name] === undefined) {
            return -1;
        }

        return ElementUtil.Element[name][0];

//        const element = toElement(name);
//        if (element == null) {
//            return -1;
//        }
