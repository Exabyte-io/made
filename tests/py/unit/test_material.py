...
def test_create():
    ...
    assert isinstance(material.BasisCls, Basis)
    assert isinstance(material.LatticeCls, Lattice)
...
def test_basis_cell_lattice_sync():
    ...
    assertion_utils.assert_deep_almost_equal(new_vectors, material.BasisCls.cell.vectors_as_array)

    assertion_utils.assert_deep_almost_equal(new_vectors, material.LatticeCls.vector_arrays)
