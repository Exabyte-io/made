...
def test_rotation_detection_and_correction():
    ...
    self_rotation_analyzer = MaterialRotationAnalyzer(material=material)
    self_rotation_info = self_rotation_analyzer.detect_rotation_from_original(material, layer_thickness=0.5)
