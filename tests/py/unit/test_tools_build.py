...
from mat3ra.made.tools.build.interface import InterfaceSettings, ZSLParameters
...
settings = InterfaceSettings(use_conventional_cell=True, ZSLParameters=ZSLParameters(max_area=MAX_AREA))
