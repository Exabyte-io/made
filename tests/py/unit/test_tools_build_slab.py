...
XY_SUPERCELL_MATRIX = [[2, 0], [0, 2]]  # Use a larger supercell for testing
...
def test_build_slab():
    ...
    oriented_crystal = CrystalLatticePlanesConfiguration(crystal=conventional_cell, miller_indices=MILLER_INDICES)
